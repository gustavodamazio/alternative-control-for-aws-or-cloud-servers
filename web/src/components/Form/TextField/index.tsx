...
const TextField: React.FC<TextFieldProps> = ({ name, helperText, defaultValue, InputLabelProps, ...restProps }) => {
  if (!name) {
    printWarning('TextField component must have a `name` property for correctly working.')
  }
