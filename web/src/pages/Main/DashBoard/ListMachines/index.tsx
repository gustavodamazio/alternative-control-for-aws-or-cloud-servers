    ...
    <>
      ...
      >
        <AgGridReact onGridReady={onGridReady} rowData={rowData} pagination={true} paginationPageSize={100}>
          ...
          <AgGridColumn field="instance_type" headerName="Tipo" maxWidth={130} sortable={true} filter={true}></AgGridColumn>
          <AgGridColumn
            ...
            filter={true}
          ></AgGridColumn>
          <AgGridColumn field="private_ip_address" headerName="Ip privado" maxWidth={150} sortable={true} filter={true}></AgGridColumn>
          <AgGridColumn field="memory_mb" headerName="Memória (MB)" maxWidth={150} sortable={true} filter={true}></AgGridColumn>
